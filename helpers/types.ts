...
export type iModePoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'WETH' | 'USDC' | 'USDT' | 'WSTETH' | 'STONE' | 'EZETH'
>;
...
export interface IModeConfiguration extends ICommonConfiguration {
  ReservesConfig: iModePoolAssets<IReserveParams>;
}
